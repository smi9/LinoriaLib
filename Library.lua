		...
		do
			...
			function Funcs:AddKeyPicker(Idx, Info)
				...
				function KeyPicker:GetState()
					...
					elseif (KeyPicker.Mode == "OnClick") then
						return false;
					else
				...
				function KeyPicker:DoClick()
					if (ParentObj.Type == 'Toggle' or ParentObj.Type == "OnClick") and KeyPicker.SyncToggleState then
				...
				Library:GiveSignal(InputService.InputBegan:Connect(function(Input,G)
					if (not Picking and not G and not TextBoxFocused) then
						if (KeyPicker.Mode == 'Toggle' or KeyPicker.Mode == "OnClick") then
							local Key = KeyPicker.Value;
